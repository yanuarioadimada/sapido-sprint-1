<x-dashboard-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div>
            <h4 class="text-3xl font-bold text-gray-800 mb-4">Kelahiran & Kematian</h4>
        </div>
        <div class="w-100 mb-4 flex justify-end">
            <a href="{{route('kelahiran-kematian.create')}}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah Data</a>
        </div>
