<x-dashboard-layout>
    ...
    <form action="{{route('kelahiran-kematian.update',$data->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-6">
        ...
        <div class="mb-6">
            <label for="jenis" class="{{$errors->has('jenis') ? 'text-red-700' : 'text-gray-900'}} block mb-2 text-sm font-medium">Nomor Hewan</label>
