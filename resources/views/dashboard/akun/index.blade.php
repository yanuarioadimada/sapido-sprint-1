<x-dashboard-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <h4 class="text-3xl font-bold text-gray-800 mb-2">Data Akun Kelompok Ternak</h4>
        <p class="text-xl font-bold text-gray-500">- Admin -</p>
        <div class="w-100 mb-4 flex justify-end">
            <a href="{{route('akun.create')}}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Buat akun</a>
        </div>
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        {{$item->profile ? $item->profile->foto_profil : ''}}
                    </td>
                    
                    <td class="px-6 py-4 text-right">
                        @if($item->profile)
                        <a target="_blank" class="w-4" href="{{$item->profile->foto_profil ? url($item->profile->foto_profil) : ''}}">
                            @if($item->profile->foto_profil)
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{route('akun.edit',$item->id)}}" class="font-medium mr-2 text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
